...
object mod {
  ...
  object ReactElement {
    ...
    @scala.inline
    def apply(props: js.Any, `type`: String | ComponentClassP[js.Object] | SFC[?]): ReactElement = {
    ...
    implicit class ReactElementOps[Self <: Element] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setType(value: String | ComponentClassP[js.Object] | SFC[?]): Self = this.set("type", value.asInstanceOf[js.Any])
