...
object NewLifecycle {
  ...
  implicit class NewLifecycleOps[Self <: NewLifecycle[?, ?, ?], P, S, SS] (val x: Self & (NewLifecycle[P, S, SS])) extends AnyVal {
    ...
    @scala.inline
    def setComponentDidUpdate(value: (/* prevProps */ P, /* prevState */ S, /* snapshot */ scala.Unit | SS) => Callback): Self = this.set("componentDidUpdate", js.Any.fromFunction3((t0: /* prevProps */ P, t1: /* prevState */ S, t2: /* snapshot */ scala.Unit | SS) => (value(t0, t1, t2)).runNow()))
