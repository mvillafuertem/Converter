...
object Mixin {
  ...
  implicit class MixinOps[Self <: Mixin[?, ?], P, S] (val x: Self & (Mixin[P, S])) extends AnyVal {
    ...
    @scala.inline
    def setGetDefaultProps(value: CallbackTo[P]): Self = this.set("getDefaultProps", value.toJsFn)
    
    @scala.inline
    def deleteGetDefaultProps: Self = this.set("getDefaultProps", ())
    
    @scala.inline
    def setGetInitialState(value: CallbackTo[S]): Self = this.set("getInitialState", value.toJsFn)
