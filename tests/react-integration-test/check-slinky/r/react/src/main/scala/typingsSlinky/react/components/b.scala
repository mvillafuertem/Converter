...
object b {
  ...
  implicit def make(companion: b.type): SharedBuilder_DetailedHTMLProps1276931637[HTMLElement & js.Object] = new SharedBuilder_DetailedHTMLProps1276931637[HTMLElement & js.Object](js.Array(this.component, js.Dictionary.empty))()
}
